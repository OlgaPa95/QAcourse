...
class Students extends Members {
    ...
    */
    ...
    changeCourse(newCourseName){
        if(this.#isCourseNameValid(newCourseName) && this.#student.sCourseDetails.courseName!= newCourseName){
           ...
           ( (this.#isCourseNameValid(newCourseName)) != 0 ){
            console.log('Invalid course name')
           }//course.courseName.toLowerCase().localeCompare(checkForCourse.toLowerCase()) === 0
           //(this.#isCourseNameValid(newCourseName) === this.#student.sCourseDetails.courseName)
           else if(this.#student.sCourseDetails.courseName.toLowerCase().localeCompare(newCourseName.toLowerCase()) === 0){
                   console.log('You are already enrolled in the course with this name')
           }
    ...
    makePayment(amount){      
        ...
        }else if(this.#student.sBalance==0){
            console.log('No more payment required.')
        }
        else if(amount>=this.#student.sBalance){
